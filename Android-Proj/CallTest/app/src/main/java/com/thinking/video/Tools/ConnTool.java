...
public class ConnTool {
    ...
    public void init(Object... _params) {
        ...
        //初始化连接参数
        ConnParams params = new ConnParams(true, false, displaySize.x, displaySize.y, 30, 1, VIDEO_CODEC_VP9, true, 1, AUDIO_CODEC_OPUS, true);
        //初始化连接框架
    ...
    private PeerConnection.Observer mPCObserver = new PeerConnection.Observer() {
        ...
        public void onIceGatheringChange(PeerConnection.IceGatheringState iceGatheringState) {
            ...
            if (iceGatheringState == PeerConnection.IceGatheringState.COMPLETE) {
                Message msg = new Message();
                msg.obj = new Result("onIceGatheringChange", mParams, true);
                msg.what = 1001;
                mHandler.sendMessage(msg);
            }
        }
