...
public class CallActivity extends Activity implements ConnTool.onResutListener {

    private Button btn_init;
    private Button btn_create_conn;
    private Button btn_receive_answer;
    ...
    private void inutUI() {
        ...
        btn_receive_answer = (Button) findViewById(R.id.btn_receive_answer);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_receive_answer) {
    ...
    public void onFinished(ConnTool.Result result) {
        ...
        if (result.methodName.equals("createOffer") && result.result) {
            btn_receive_answer.setClickable(true);
            btn_receive_answer.setTextColor(Color.WHITE);
        }
